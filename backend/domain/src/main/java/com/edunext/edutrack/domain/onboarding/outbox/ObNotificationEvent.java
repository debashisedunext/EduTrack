 ...
 *
 * <p>No IN_APP titles. B-112 decides what an onboarding bell entry looks like
 * (B-110's note on the same line), and inventing one here would be a second
...
public enum ObNotificationEvent {
    ...
    ObNotificationEvent(Set<String> requiredVariables, Set<String> optionalVariables) {
