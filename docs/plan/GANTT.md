...
**Generated Thu 20 Aug 2026 · day 13 of the plan · finish forecast Thu 10 Sep**
...
| | Tasks | Effort (days) |
|---|---:|---:|
| Complete | 205 of 244 (84%) | 302.5 of 365.8 (83%) |
| In flight | 9 | 11.8 |
| On the driving chain | 14 | 21.0 |
| Zero float (no slack at all) | 30 | 49.5 |

### By developer

| Stream | Developer | Tasks | Done | Effort | Working days available | Load | Finishes |
|---|---|---:|---:|---:|---:|---:|---|
| **A** | Shivendra | 65 | 57 | 95.0 | 28 | 339% ⚠️ | Wed 09 Sep |
| **B** | Ayush | 55 | 44 | 89.8 | 28 | 321% ⚠️ | Thu 10 Sep |
| **C** | Divyansh | 59 | 45 | 90.0 | 28 | 321% ⚠️ | Thu 10 Sep |
| **D** | Debashis | 65 | 59 | 91.0 | 28 | 325% ⚠️ | Sat 29 Aug |

### Slipping

| Task | Owner | Baseline end | Forecast end | Slip |
|---|---|---|---|---:|
| `A-023` Opaque refresh token, 7 days, HttpOnly + Secure  | Shivendra | Fri 14 Aug | Mon 10 Aug | +20d |
| `A-025` Logout | Shivendra | Tue 18 Aug | Mon 10 Aug | +18d |
| `A-026` Forced password change on first login — must_cha | Shivendra | Wed 19 Aug | Mon 10 Aug | +17d |
| `B-007` Ticket fixture corpus | Ayush | Wed 19 Aug | Mon 10 Aug | +17d |
| `A-027` Forgot/reset password — single-use, 30-min TTL,  | Shivendra | Thu 20 Aug | Mon 10 Aug | +16d |
| `C-011` Ticket ID generation | Divyansh | Thu 20 Aug | Mon 10 Aug | +16d |
| `B-006` MapStruct base configuration | Ayush | Fri 21 Aug | Mon 10 Aug | +15d |
| `B-031` Step 1 — template download | Ayush | Tue 25 Aug | Mon 17 Aug | +14d |
| `C-010` Create ticket — all field groups from blueprint  | Divyansh | Tue 25 Aug | Mon 10 Aug | +13d |
| `B-032` Step 2 — upload, max 5 MB / 5,000 rows, event-dr | Ayush | Thu 27 Aug | Mon 17 Aug | +12d |
| `C-013` Actions: Save & Assign · Save as Draft · Save &  | Divyansh | Wed 26 Aug | Mon 10 Aug | +12d |
...
| 4 | `C-032` | Divyansh | Stamping | 1 | Thu 20 Aug | Thu 20 Aug | `C-042` finished |
| 5 | `C-044` | Divyansh | Handoff dialog — next stage | 2.5 | Thu 20 Aug | Thu 20 Aug | Divyansh was busy on `C-032` |
| 6 | `C-045` | Divyansh | On submit: seal the current row | 2 | Fri 21 Aug | Fri 21 Aug | `C-044` finished |
| 7 | `C-048` | Divyansh | Force-move (OVERRIDE) — PM/Admin, logged as an overr | 1 | Sat 22 Aug | Sat 22 Aug | Divyansh was busy on `C-045` |
| 8 | `C-049` | Divyansh | Reassignment within a stage does not create a new se | 1.5 | Sat 22 Aug | Sat 22 Aug | Divyansh was busy on `C-048` |
| 9 | `C-050` | Divyansh | Unassigned receiving role → ticket falls to a projec | 1 | Tue 25 Aug | Tue 25 Aug | Divyansh was busy on `C-049` |
| 10 | `C-071` | Divyansh | Per-project settings are configurable and ignored | 1 | Tue 25 Aug | Wed 26 Aug | Divyansh was busy on `C-050` |
| 11 | `C-046` | Divyansh | Backward moves | 1.5 | Wed 26 Aug | Thu 27 Aug | Divyansh was busy on `C-071` |
| 12 | `C-047` | Divyansh | Skip a stage | 1 | Fri 28 Aug | Fri 28 Aug | Divyansh was busy on `C-046` |
| 13 | `C-072` | Divyansh | A deactivated priority can still be chosen | 1 | Sat 29 Aug | Sat 29 Aug | Divyansh was busy on `C-047` |
| 14 | `C-051` | Divyansh | Ribbon component | 3 | Tue 01 Sep | Thu 03 Sep | Divyansh was busy on `C-072` |
| 15 | `C-052` | Divyansh | Interactions | 2 | Fri 04 Sep | Sat 05 Sep | `C-051` finished |
| 16 | `C-053` | Divyansh | Cycle selector above the ribbon; selecting cycle 1 r | 1.5 | Tue 08 Sep | Wed 09 Sep | Divyansh was busy on `C-052` |
| 17 | `C-054` | Divyansh | Cycle 2 · Iteration 3 chips | 1 | Wed 09 Sep | Thu 10 Sep | Divyansh was busy on `C-053` |
...
gantt
    ...
    excludes weekends
    section Milestones
    Sprint 0 — weeks 1–2 :done, b0, 2026-08-06, 27d
    M3 — Master data — weeks 3–9 :active, b1, 2026-08-10, -9d
    Weeks 12–14 — M6 reports :active, b2, 2026-08-19, 17d
...
gantt
    ...
    M4 — Tickets — weeks 3–14 :active, c1, 2026-08-08, 24d
```
...
|---|---|---|---:|---|---|---|---:|---|
|  | `A-001` | Maven multi-module skeleton: common, domain, api, worker | 1 | — | Thu 20 Aug | Thu 20 Aug | 13 | ✅ done |
|  | `A-002` | docker-compose.yml — MySQL 8.4, Redis 7, MinIO, Mailpit | 1 | `A-001` | Thu 20 Aug | Thu 20 Aug | 14 | ✅ done |
...
|  | `A-007` | Flyway baseline 5/5 — masters & ops | 1.5 | `A-005` | Thu 20 Aug | Thu 20 Aug | 14 | ✅ done |
|  | `A-008` | Immutability triggers — two per table | 1 | `A-004` `A-005` | Thu 20 Aug | Thu 20 Aug | 13 | ✅ done |
|  | `A-009` | Generated columns + indexes replacing PostgreSQL partial indexes | 0.5 | `A-006` | Thu 20 Aug | Thu 20 Aug | 14 | ✅ done |
|  | `A-010` | Two DB users: edutrack_app | 0.5 | `A-009` ᶦ | Thu 06 Aug | Thu 06 Aug | 0 | ✅ done |
|  | `A-011` | CI pipeline | 1.5 | `A-001` | Thu 20 Aug | Thu 20 Aug | 15 | ✅ done |
...
|  | `A-030` | Login screen | 1.5 | `A-020` `C-003` | Thu 20 Aug | Thu 20 Aug | 14 | ✅ done |
...
|  | `A-058` | Widgets 16–19 — stage funnel, rework/ping-pong, avg time per stage | 2.5 | `A-056` `C-049` | Sat 05 Sep | Wed 09 Sep | 1 | ▫️ to do |
...
|  | `A-070` | "Born critical vs became critical" report | 1 | `A-066` `D-028` | Thu 20 Aug | Thu 20 Aug | 13 | 🔵 in review |
...
| 🔴 | `B-042` | Stages in use may be deprecated, never deleted | 1 | `B-040` | Wed 19 Aug | Wed 19 Aug | 1 | ✅ done |
...
|  | `B-052` | Ribbon accessibility | 1.5 | `B-050` ᶦ | Sat 29 Aug | Tue 01 Sep | 0 | ▫️ to do |
|  | `B-053` | Readability at 8 stages on a laptop | 2 | `B-050` ᶦ | Wed 02 Sep | Thu 03 Sep | 0 | ▫️ to do |
...
| 🔴 | `B-064` | Module master read endpoint | 0.25 | `C-065` | Thu 20 Aug | Thu 20 Aug | 14 | 🔵 in review |
|  | `B-065` | 🟡 Timesheet approval | 1 | — | Fri 04 Sep | Fri 04 Sep | 0 | ▫️ to do |
|  | `B-066` | Client 360 | 2 | — | Sat 05 Sep | Tue 08 Sep | 0 | ▫️ to do |
|  | `B-067` | Masters index — the sidebar's Masters entry lands on a placeholder | 1 | — | Wed 09 Sep | Wed 09 Sep | 0 | ▫️ to do |
|  | `B-068` | 🟡 Org settings screen — or the decision that the API is enough | 1 | — | Thu 10 Sep | Thu 10 Sep | 0 | ▫️ to do |
...
| ▲ | `C-032` | Stamping | 1 | `C-029` `C-042` | Thu 20 Aug | Thu 20 Aug | 0 | 🔵 in review |
...
| ▲ | `C-044` | Handoff dialog — next stage | 2.5 | `C-042` `C-035` | Thu 20 Aug | Thu 20 Aug | 0 | 🔵 in review |
| ▲ | `C-045` | On submit: seal the current row | 2 | `C-044` `D-014` | Fri 21 Aug | Fri 21 Aug | 0 | 🟡 50% |
| ▲ | `C-046` | Backward moves | 1.5 | `C-042` ᶦ | Wed 26 Aug | Thu 27 Aug | 0 | ▫️ to do |
| ▲ | `C-047` | Skip a stage | 1 | `C-042` ᶦ | Fri 28 Aug | Fri 28 Aug | 0 | ▫️ to do |
| ▲ | `C-048` | Force-move (OVERRIDE) — PM/Admin, logged as an override | 1 | `C-042` ᶦ | Sat 22 Aug | Sat 22 Aug | 0 | 🟡 50% |
| ▲ | `C-049` | Reassignment within a stage does not create a new segment | 1.5 | `C-042` | Sat 22 Aug | Sat 22 Aug | 0 | 🔵 in review |
| ▲ | `C-050` | Unassigned receiving role → ticket falls to a project-level queue… | 1 | `C-044` ᶦ | Tue 25 Aug | Tue 25 Aug | 0 | 🔵 in review |
| ▲🔴 | `C-051` | Ribbon component | 3 | `B-050` | Tue 01 Sep | Thu 03 Sep | 0 | ▫️ to do |
| ▲ | `C-052` | Interactions | 2 | `C-051` ᶦ | Fri 04 Sep | Sat 05 Sep | 0 | ▫️ to do |
| ▲ | `C-053` | Cycle selector above the ribbon; selecting cycle 1 renders that… | 1.5 | `C-051` `C-038` | Tue 08 Sep | Wed 09 Sep | 0 | ▫️ to do |
| ▲ | `C-054` | Cycle 2 · Iteration 3 chips | 1 | `C-051` `C-046` | Wed 09 Sep | Thu 10 Sep | 0 | ▫️ to do |
...
| ▲🔴 | `C-071` | Per-project settings are configurable and ignored | 1 | — | Tue 25 Aug | Wed 26 Aug | 0 | ▫️ to do |
| ▲ | `C-072` | A deactivated priority can still be chosen | 1 | — | Sat 29 Aug | Sat 29 Aug | 0 | ▫️ to do |
...
|  | `D-058` | Live ribbon advance | 1 | `D-014` `C-045` | Fri 28 Aug | Fri 28 Aug | 8 | ▫️ to do |
|  | `D-059` | Team inbox live updates | 1 | `D-058` `C-062` | Sat 29 Aug | Sat 29 Aug | 8 | ▫️ to do |
...
|  | `D-066` | 🟡 S-12 promises "Admin can add levels" and the contract cannot… | 1 | — | Thu 27 Aug | Thu 27 Aug | 8 | ▫️ to do |
