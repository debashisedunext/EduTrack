...
| | Tasks | Effort (days) |
|---|---:|---:|
| Complete | 205 of 241 (85%) | 302.5 of 362.8 (83%) |
| In flight | 9 | 11.8 |
| On the driving chain | 11 | 16.8 |
| Zero float (no slack at all) | 16 | 28.5 |
...
| **C** | Divyansh | 57 | 45 | 88.0 | 28 | 314% ⚠️ | Tue 08 Sep |
| **D** | Debashis | 64 | 59 | 90.0 | 28 | 321% ⚠️ | Fri 28 Aug |
...
|  | `C-032` | Stamping | 1 | `C-029` `C-042` | Thu 20 Aug | Thu 20 Aug | 8 | 🔵 in review |
...
|  | `C-044` | Handoff dialog — next stage | 2.5 | `C-042` `C-035` | Thu 20 Aug | Thu 20 Aug | 9 | 🔵 in review |
|  | `C-045` | On submit: seal the current row | 2 | `C-044` `D-014` | Fri 21 Aug | Fri 21 Aug | 9 | 🟡 50% |
|  | `C-046` | Backward moves | 1.5 | `C-042` ᶦ | Tue 25 Aug | Wed 26 Aug | 1 | ▫️ to do |
|  | `C-047` | Skip a stage | 1 | `C-042` ᶦ | Thu 27 Aug | Thu 27 Aug | 1 | ▫️ to do |
|  | `C-048` | Force-move (OVERRIDE) — PM/Admin, logged as an override | 1 | `C-042` ᶦ | Sat 22 Aug | Sat 22 Aug | 9 | 🟡 50% |
|  | `C-049` | Reassignment within a stage does not create a new segment | 1.5 | `C-042` | Sat 22 Aug | Sat 22 Aug | 10 | 🔵 in review |
|  | `C-050` | Unassigned receiving role → ticket falls to a project-level queue… | 1 | `C-044` ᶦ | Tue 25 Aug | Tue 25 Aug | 10 | 🔵 in review |
| 🔴 | `C-051` | Ribbon component | 3 | `B-050` | Fri 28 Aug | Tue 01 Sep | 1 | ▫️ to do |
|  | `C-052` | Interactions | 2 | `C-051` ᶦ | Wed 02 Sep | Thu 03 Sep | 1 | ▫️ to do |
|  | `C-053` | Cycle selector above the ribbon; selecting cycle 1 renders that… | 1.5 | `C-051` `C-038` | Fri 04 Sep | Sat 05 Sep | 1 | ▫️ to do |
|  | `C-054` | Cycle 2 · Iteration 3 chips | 1 | `C-051` `C-046` | Sat 05 Sep | Tue 08 Sep | 2 | ▫️ to do |
...
|  | `D-037` | All 15 mail events from §4B.6 wired | 2 | `D-030` `D-036` ᶦ | Tue 25 Aug | Tue 25 Aug | 9 | ⛔ blocked |
...
|  | `D-053` | File and image share, emoji, message search | 2 | `D-050` ᶦ | Wed 26 Aug | Wed 26 Aug | 9 | ⛔ blocked |
...
|  | `D-058` | Live ribbon advance | 1 | `D-014` `C-045` | Thu 27 Aug | Thu 27 Aug | 9 | ▫️ to do |
|  | `D-059` | Team inbox live updates | 1 | `D-058` `C-062` | Fri 28 Aug | Fri 28 Aug | 9 | ▫️ to do |
...
| 🔴 | `D-065` | The chat React surface | 3 | — | Thu 20 Aug | Sat 22 Aug | 9 | ▫️ to do |
