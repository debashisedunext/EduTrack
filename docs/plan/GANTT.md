...
**Generated Tue 11 Aug 2026 · day 6 of the plan · finish forecast Wed 02 Dec**
...
|---|---|---|---|---:|
| `A-023` Opaque refresh token, 7 days, HttpOnly + Secure  | Shivendra | Fri 14 Aug | Mon 10 Aug | +79d |
| `D-004` MSW mock server returning realistic fixtures for | Debashis | Fri 14 Aug | Mon 10 Aug | +79d |
| `A-025` Logout | Shivendra | Tue 18 Aug | Mon 10 Aug | +77d |
| `A-026` Forced password change on first login — must_cha | Shivendra | Wed 19 Aug | Mon 10 Aug | +76d |
| `C-011` Ticket ID generation | Divyansh | Thu 20 Aug | Mon 10 Aug | +75d |
| `B-006` MapStruct base configuration | Ayush | Fri 21 Aug | Mon 10 Aug | +74d |
| `C-010` Create ticket — all field groups from blueprint  | Divyansh | Tue 25 Aug | Mon 10 Aug | +72d |
...
| 36 | `C-045` | Divyansh | On submit: seal the current row | 2 | Thu 29 Oct | Fri 30 Oct | `C-044` finished |
| 37 | `C-046` | Divyansh | Backward moves | 1.5 | Sat 31 Oct | Tue 03 Nov | Divyansh was busy on `C-045` |
| 38 | `C-047` | Divyansh | Skip a stage | 1 | Tue 03 Nov | Wed 04 Nov | Divyansh was busy on `C-046` |
| 39 | `C-048` | Divyansh | Force-move (OVERRIDE) — PM/Admin, logged as an overr | 1 | Wed 04 Nov | Thu 05 Nov | Divyansh was busy on `C-047` |
| 40 | `C-049` | Divyansh | Reassignment within a stage does not create a new se | 1.5 | Thu 05 Nov | Fri 06 Nov | Divyansh was busy on `C-048` |
| 41 | `C-050` | Divyansh | Unassigned receiving role → ticket falls to a projec | 1 | Sat 07 Nov | Sat 07 Nov | Divyansh was busy on `C-049` |
| 42 | `C-062` | Divyansh | Stage Queue / team inbox | 2 | Tue 10 Nov | Wed 11 Nov | Divyansh was busy on `C-050` |
| 43 | `C-055` | Divyansh | Roll-up grid | 2 | Thu 12 Nov | Fri 13 Nov | Divyansh was busy on `C-062` |
| 44 | `C-056` | Divyansh | Active vs idle split | 1.5 | Sat 14 Nov | Tue 17 Nov | `C-055` finished |
| 45 | `C-057` | Divyansh | Per-resource roll-up + cycle total + all-cycles tota | 1.5 | Tue 17 Nov | Wed 18 Nov | `C-056` finished |
| 46 | `C-058` | Divyansh | Roll-up query | 1 | Thu 19 Nov | Thu 19 Nov | Divyansh was busy on `C-057` |
| 47 | `C-043` | Divyansh | The golden rule — only the current stage owner | 1.5 | Fri 20 Nov | Sat 21 Nov | Divyansh was busy on `C-058` |
| 48 | `C-051` | Divyansh | Ribbon component | 3 | Sat 21 Nov | Thu 26 Nov | Divyansh was busy on `C-043` |
| 49 | `C-052` | Divyansh | Interactions | 2 | Thu 26 Nov | Sat 28 Nov | `C-051` finished |
| 50 | `C-053` | Divyansh | Cycle selector above the ribbon; selecting cycle 1 r | 1.5 | Sat 28 Nov | Tue 01 Dec | Divyansh was busy on `C-052` |
| 51 | `C-054` | Divyansh | Cycle 2 · Iteration 3 chips | 1 | Wed 02 Dec | Wed 02 Dec | Divyansh was busy on `C-053` |
...
gantt
    ...
    M6 — Dashboard & reports — weeks 10–16 :a3, 2026-09-11, 53d
...
gantt
    ...
    M4 — Tickets — weeks 3–14 :active, c1, 2026-08-08, 83d
```
...
gantt
    ...
    excludes weekends
    section Milestones
    Sprint 0 — weeks 1–2 :done, d0, 2026-08-06, 86d
    Infrastructure — weeks 3–5 :done, d1, 2026-08-07, 85d
    M5 — SLA  escalation & mail — weeks 6–11 :active, d2, 2026-08-07, 59d
...
|---|---|---|---:|---|---|---|---:|---|
|  | `A-001` | Maven multi-module skeleton: common, domain, api, worker | 1 | — | Tue 11 Aug | Tue 11 Aug | 79 | ✅ done |
|  | `A-002` | docker-compose.yml — MySQL 8.4, Redis 7, MinIO, Mailpit | 1 | `A-001` | Tue 11 Aug | Tue 11 Aug | 80 | ✅ done |
...
|  | `A-007` | Flyway baseline 5/5 — masters & ops | 1.5 | `A-005` | Tue 11 Aug | Tue 11 Aug | 80 | ✅ done |
|  | `A-008` | Immutability triggers — two per table | 1 | `A-004` `A-005` | Tue 11 Aug | Tue 11 Aug | 79 | ✅ done |
|  | `A-009` | Generated columns + indexes replacing PostgreSQL partial indexes | 0.5 | `A-006` | Tue 11 Aug | Tue 11 Aug | 27 | ✅ done |
|  | `A-010` | Two DB users: edutrack_app | 0.5 | `A-009` ᶦ | Thu 06 Aug | Thu 06 Aug | 12 | ✅ done |
|  | `A-011` | CI pipeline | 1.5 | `A-001` | Tue 11 Aug | Tue 11 Aug | 81 | ✅ done |
...
|  | `A-021` | failed_attempts counter, 15-minute lockout at 5, email to Admin on… | 0.5 | `A-020` ᶦ | Sat 08 Aug | Sat 08 Aug | 82 | ✅ done |
...
| 🔴 | `A-024` | Refresh rotation with family revocation | 1.5 | `A-023` | Sat 08 Aug | Sat 08 Aug | 82 | ✅ done |
...
|  | `A-050` | daily_ticket_stats and resource_daily_stats summary tables | 1.5 | `A-034` `B-007` ᶦ | Wed 23 Sep | Thu 24 Sep | 1 | ▫️ to do |
|  | `A-051` | 5-minute refresh worker. Dashboard reads never issue live COUNT() | 1 | `A-050` | Thu 24 Sep | Fri 25 Sep | 2 | ▫️ to do |
...
|  | `A-054` | Shell, role-aware, with project/date/resource filters | 1.5 | `A-051` `C-005` ᶦ | Fri 25 Sep | Sat 26 Sep | 3 | ▫️ to do |
|  | `A-055` | Widgets 1–6 — KPI cards with sparklines and animated count-up | 2 | `A-054` ᶦ | Tue 29 Sep | Wed 30 Sep | 3 | ▫️ to do |
|  | `A-056` | Widgets 7–12 | 3 | `A-055` ᶦ | Thu 01 Oct | Sat 03 Oct | 3 | ▫️ to do |
|  | `A-057` | Widgets 13–15 — calendar heatmap, SLA radial gauge, project treemap | 2 | `A-056` ᶦ | Tue 06 Oct | Wed 07 Oct | 3 | ▫️ to do |
|  | `A-058` | Widgets 16–19 — stage funnel, rework/ping-pong, avg time per stage | 2.5 | `A-056` `C-049` | Tue 10 Nov | Thu 12 Nov | 11 | ▫️ to do |
|  | `A-059` | Widget 20 — client-wise volume. Depends on Stream B's client master | 1 | `A-056` `B-029` | Sat 07 Nov | Sat 07 Nov | 11 | ▫️ to do |
|  | `A-060` | Every card and chart segment deep-links to a pre-filtered list | 1.5 | `A-056` `C-014` ᶦ | Fri 23 Oct | Sat 24 Oct | 8 | ▫️ to do |
|  | `A-061` | Drill-down modal, slides from the right, CSV export | 1.5 | `A-060` ᶦ | Tue 27 Oct | Wed 28 Oct | 8 | ▫️ to do |
|  | `A-062` | Developer dashboard variant | 1.5 | `A-055` ᶦ | Thu 08 Oct | Fri 09 Oct | 3 | ▫️ to do |
|  | `A-063` | Reports hub | 2 | `A-051` `C-003` ᶦ | Fri 09 Oct | Tue 13 Oct | 4 | ▫️ to do |
|  | `A-064` | Export engine — Excel, CSV, PDF | 2 | `A-063` ᶦ | Tue 13 Oct | Thu 15 Oct | 5 | ▫️ to do |
|  | `A-065` | Scheduled report email (daily/weekly/monthly) | 1 | `A-064` `D-029` | Fri 06 Nov | Fri 06 Nov | 11 | ▫️ to do |
|  | `A-066` | Reports 1–6 | 3 | `A-063` ᶦ | Thu 15 Oct | Tue 20 Oct | 6 | ▫️ to do |
|  | `A-067` | Reports 7–12 | 3 | `A-066` ᶦ | Tue 20 Oct | Fri 23 Oct | 7 | ▫️ to do |
|  | `A-068` | Reports 13–18 | 3 | `A-067` `C-058` | Fri 20 Nov | Tue 24 Nov | 6 | ▫️ to do |
|  | `A-069` | Resource 360° profile | 1.5 | `A-066` `B-010` | Tue 03 Nov | Wed 04 Nov | 11 | ▫️ to do |
|  | `A-070` | "Born critical vs became critical" report | 1 | `A-066` `D-028` | Thu 05 Nov | Thu 05 Nov | 11 | ▫️ to do |
|  | `A-071` | Audit Log Viewer | 1.5 | `A-034` ᶦ | Wed 16 Sep | Thu 17 Sep | 0 | ▫️ to do |
|  | `A-072` | Global search + ticket-ID deep link | 1.5 | `A-009` `C-005` ᶦ | Thu 17 Sep | Fri 18 Sep | 1 | ▫️ to do |
|  | `A-073` | Performance | 2 | `A-053` `B-007` ᶦ | Wed 28 Oct | Fri 30 Oct | 9 | ▫️ to do |
|  | `A-074` | Security | 2 | `A-036` ᶦ | Sat 19 Sep | Tue 22 Sep | 1 | ▫️ to do |
...
|  | `C-004` | Storybook, with every shared component documented | 1.5 | `C-003` | Fri 07 Aug | Fri 07 Aug | 83 | ✅ done |
|  | `C-005` | App shell | 2 | `C-003` | Fri 07 Aug | Fri 07 Aug | 0 | ✅ done |
|  | `C-006` | Command palette on Ctrl+K for jump-to-ticket | 1 | `C-005` ᶦ | Sat 08 Aug | Sat 08 Aug | 82 | ✅ done |
...
|  | `C-012` | SLA policy resolution → auto-computed Planned Close Date, previewed… | 1.5 | `C-011` `B-024` | Sat 15 Aug | Tue 18 Aug | 0 | ▫️ to do |
...
|  | `C-015` | Saved views | 1 | `C-014` ᶦ | Tue 11 Aug | Tue 11 Aug | 0 | ▫️ to do |
|  | `C-016` | Row colour cues | 0.5 | `C-014` ᶦ | Wed 12 Aug | Wed 12 Aug | 0 | ▫️ to do |
|  | `C-017` | Bulk select → reassign / change level / close (PM & Admin only) | 1.5 | `C-014` `A-034` | Fri 11 Sep | Sat 12 Sep | 0 | ▫️ to do |
|  | `C-018` | My Tasks | 2.5 | `C-014` ᶦ | Wed 12 Aug | Fri 14 Aug | 0 | ▫️ to do |
...
|  | `C-021` | Client + client-contact dependent dropdowns, type-ahead over… | 2 | `C-019` `B-028` | Fri 09 Oct | Sat 10 Oct | 0 | ▫️ to do |
|  | `C-022` | Client-raised flag driving client-wise reports, CSAT and the… | 0.5 | `C-021` ᶦ | Tue 13 Oct | Tue 13 Oct | 0 | ▫️ to do |
...
| ▲ | `C-032` | Stamping | 1 | `C-029` `C-042` | Fri 23 Oct | Sat 24 Oct | 0 | ▫️ to do |
|  | `C-033` | 5-minute edit window, then locked with an "edited" marker and the… | 1.5 | `C-029` ᶦ | Sat 05 Sep | Tue 08 Sep | 0 | ▫️ to do |
| 🔴 | `C-034` | Interleave comments into the History tab | 1.5 | `C-029` `C-059` | Tue 06 Oct | Wed 07 Oct | 0 | ▫️ to do |
|  | `C-035` | Effort logging, append-only, auto-stamped with current stage and… | 1.5 | `C-019` `A-040` | Thu 24 Sep | Fri 25 Sep | 0 | ▫️ to do |
|  | `C-036` | Quick Update slide-over | 2.5 | `C-018` `C-035` ᶦ | Fri 25 Sep | Tue 29 Sep | 0 | ▫️ to do |
|  | `C-037` | Quick Update must not expose | 0.5 | `C-036` ᶦ | Wed 30 Sep | Wed 30 Sep | 0 | ▫️ to do |
| 🔴 | `C-038` | Reopen transaction — seal cycle N | 2.5 | `C-013` `A-040` | Wed 16 Sep | Fri 18 Sep | 0 | ▫️ to do |
|  | `C-039` | Reopen dialog — mandatory reason, restart stage | 1.5 | `C-038` ᶦ | Sat 19 Sep | Tue 22 Sep | 0 | ▫️ to do |
|  | `C-040` | Close/resolve dialog | 1.5 | `C-038` ᶦ | Tue 22 Sep | Wed 23 Sep | 0 | ▫️ to do |
|  | `C-041` | Materialised total_effort_hrs, refreshed on every effort insert | 1 | `C-035` ᶦ | Wed 30 Sep | Thu 01 Oct | 0 | ▫️ to do |
| ▲ | `C-042` | Transition service | 2.5 | `A-042` `B-040` | Wed 21 Oct | Fri 23 Oct | 0 | ▫️ to do |
| ▲🔴 | `C-043` | The golden rule — only the current stage owner | 1.5 | `C-042` `A-033` | Fri 20 Nov | Sat 21 Nov | 0 | ▫️ to do |
| ▲ | `C-044` | Handoff dialog — next stage | 2.5 | `C-042` `C-035` | Sat 24 Oct | Wed 28 Oct | 0 | ▫️ to do |
| ▲ | `C-045` | On submit: seal the current row | 2 | `C-044` `D-014` | Thu 29 Oct | Fri 30 Oct | 0 | ▫️ to do |
| ▲ | `C-046` | Backward moves | 1.5 | `C-042` ᶦ | Sat 31 Oct | Tue 03 Nov | 0 | ▫️ to do |
| ▲ | `C-047` | Skip a stage | 1 | `C-042` ᶦ | Tue 03 Nov | Wed 04 Nov | 0 | ▫️ to do |
| ▲ | `C-048` | Force-move (OVERRIDE) — PM/Admin, logged as an override | 1 | `C-042` ᶦ | Wed 04 Nov | Thu 05 Nov | 0 | ▫️ to do |
| ▲ | `C-049` | Reassignment within a stage does not create a new segment | 1.5 | `C-042` | Thu 05 Nov | Fri 06 Nov | 0 | ▫️ to do |
| ▲ | `C-050` | Unassigned receiving role → ticket falls to a project-level queue… | 1 | `C-044` ᶦ | Sat 07 Nov | Sat 07 Nov | 0 | ▫️ to do |
| ▲🔴 | `C-051` | Ribbon component | 3 | `B-050` | Sat 21 Nov | Thu 26 Nov | 0 | ▫️ to do |
| ▲ | `C-052` | Interactions | 2 | `C-051` ᶦ | Thu 26 Nov | Sat 28 Nov | 0 | ▫️ to do |
| ▲ | `C-053` | Cycle selector above the ribbon; selecting cycle 1 renders that… | 1.5 | `C-051` `C-038` | Sat 28 Nov | Tue 01 Dec | 0 | ▫️ to do |
| ▲ | `C-054` | Cycle 2 · Iteration 3 chips | 1 | `C-051` `C-046` | Wed 02 Dec | Wed 02 Dec | 0 | ▫️ to do |
| ▲ | `C-055` | Roll-up grid | 2 | `C-042` `B-024` | Thu 12 Nov | Fri 13 Nov | 0 | ▫️ to do |
| ▲🔴 | `C-056` | Active vs idle split | 1.5 | `C-055` | Sat 14 Nov | Tue 17 Nov | 0 | ▫️ to do |
| ▲ | `C-057` | Per-resource roll-up + cycle total + all-cycles total | 1.5 | `C-056` ᶦ | Tue 17 Nov | Wed 18 Nov | 0 | ▫️ to do |
| ▲ | `C-058` | Roll-up query | 1 | `C-055` | Thu 19 Nov | Thu 19 Nov | 0 | ▫️ to do |
...
|  | `C-061` | Effort tab — every log line, sum per cycle + grand total | 1 | `C-041` ᶦ | Thu 01 Oct | Fri 02 Oct | 0 | ▫️ to do |
| ▲ | `C-062` | Stage Queue / team inbox | 2 | `C-014` `C-042` | Tue 10 Nov | Wed 11 Nov | 0 | ▫️ to do |
|  | `C-063` | Bulk reassignment wizard | 2 | `C-017` `B-014` | Sat 12 Sep | Wed 16 Sep | 0 | ▫️ to do |
...
|  | `D-003` | springdoc config + codegen pipeline | 2 | `D-002` | Thu 06 Aug | Thu 06 Aug | 81 | ✅ done |
| 🔴 | `D-004` | MSW mock server returning realistic fixtures for every endpoint | 2.5 | `D-002` | Thu 06 Aug | Mon 10 Aug | 0 | ✅ done |
|  | `D-005` | CI staleness check | 1 | `D-003` | Thu 06 Aug | Sat 08 Aug | 82 | ✅ done |
...
|  | `D-014` | Destination map per blueprint §9.3 | 1 | `D-012` | Fri 07 Aug | Fri 07 Aug | 43 | ✅ done |
|  | `D-015` | Frontend STOMP client | 1.5 | `D-014` `C-005` | Sat 08 Aug | Sat 08 Aug | 82 | ✅ done |
| 🔴 | `D-020` | SLA scanner, every 15 minutes | 2 | `D-011` `B-024` `A-009` | Sat 15 Aug | Wed 19 Aug | 43 | ▫️ to do |
|  | `D-021` | 80%-of-SLA pre-breach warning to the assignee | 1 | `D-020` ᶦ | Thu 20 Aug | Fri 21 Aug | 45 | ▫️ to do |
|  | `D-022` | Stale-task nudge — no update for 3 working days, to assignee cc RM | 1 | `D-020` ᶦ | Fri 21 Aug | Sat 22 Aug | 46 | ▫️ to do |
| 🔴 | `D-023` | Stage-SLA scanner, separate from ticket SLA | 2 | `D-020` `C-042` | Sat 24 Oct | Tue 27 Oct | 23 | ▫️ to do |
|  | `D-024` | Escalation matrix per project | 1.5 | `D-020` `B-018` | Sat 05 Sep | Tue 08 Sep | 41 | ▫️ to do |
|  | `D-025` | Ping-pong flag at iteration_no ≥ 3 → PM dashboard | 0.5 | `D-023` ᶦ | Wed 28 Oct | Wed 28 Oct | 23 | ▫️ to do |
...
|  | `D-045` | Browser push via the Web Push API for users who opt in | 1.5 | `D-043` ᶦ | Thu 13 Aug | Fri 14 Aug | 41 | ▫️ to do |
...
|  | `D-051` | Typing indicator, read receipts, unread counts | 2 | `D-050` ᶦ | Sat 08 Aug | Sat 08 Aug | 82 | ✅ done |
|  | `D-052` | @mentions firing notifications | 1.5 | `D-050` ᶦ | Sat 08 Aug | Sat 08 Aug | 82 | ✅ done |
|  | `D-053` | File and image share, emoji, message search | 2 | `D-050` ᶦ | Sat 08 Aug | Sat 08 Aug | 82 | ✅ done |
|  | `D-054` | TKT-xxxx link preview rendering as a rich ticket card | 1 | `D-050` ᶦ | Fri 14 Aug | Sat 15 Aug | 42 | ▫️ to do |
| 🔴 | `D-055` | Ask Status | 1.5 | `D-050` `C-036` | Wed 30 Sep | Thu 01 Oct | 37 | ▫️ to do |
|  | `D-056` | Manager response time recorded as a reportable metric; status… | 1 | `D-055` ᶦ | Thu 01 Oct | Fri 02 Oct | 38 | ▫️ to do |
| 🔴 | `D-057` | Chat immutable after a 5-minute edit window; deletions leave… | 1.5 | `D-050` | Sat 08 Aug | Sat 08 Aug | 82 | ✅ done |
|  | `D-058` | Live ribbon advance | 1 | `D-014` `C-045` | Sat 31 Oct | Sat 31 Oct | 21 | ▫️ to do |
|  | `D-059` | Team inbox live updates | 1 | `D-058` `C-062` | Thu 12 Nov | Thu 12 Nov | 14 | ▫️ to do |
