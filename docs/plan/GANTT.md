...
**Generated Tue 15 Sep 2026 · day 31 of the plan · finish forecast Fri 18 Sep**
...
Interactive chart: [`gantt.html`](gantt.html) · Today's briefs: [`standup/2026-09-15.md`](standup/2026-09-15.md)
...
|---|---|---:|---:|---:|---:|---:|---|
| **A** | Shivendra | 65 | 64 | 95.0 | 31 | 306% ⚠️ | Wed 16 Sep |
| **B** | Ayush | 55 | 55 | 89.8 | 31 | 290% ⚠️ | Sat 22 Aug |
| **C** | Divyansh | 59 | 59 | 90.0 | 31 | 290% ⚠️ | Tue 08 Sep |
| **D** | Debashis | 65 | 65 | 91.0 | 31 | 294% ⚠️ | Sat 22 Aug |
...
| Stream | Developer | Tasks | Done | Effort | Working days available | Load | Finishes |
|---|---|---:|---:|---:|---:|---:|---|
| **A** | Shivendra | 29 | 29 | 58.0 | 12 | 483% ⚠️ | Tue 15 Sep |
| **B** | Ayush | 27 | 24 | 52.0 | 12 | 433% ⚠️ | Fri 18 Sep |
| **C** | Divyansh | 25 | 25 | 64.0 | 12 | 533% ⚠️ | Wed 09 Sep |
| **D** | Debashis | 2 | 0 | 4.0 | 12 | 33% | Fri 18 Sep |
...
| Stream | Developer | Tasks | Done | Effort | Working days available | Load | Finishes |
|---|---|---:|---:|---:|---:|---:|---|
| **A** | Shivendra | 94 | 93 | 153.0 | 34 | 450% ⚠️ | Wed 16 Sep |
| **B** | Ayush | 82 | 79 | 141.8 | 34 | 417% ⚠️ | Fri 18 Sep |
| **C** | Divyansh | 84 | 84 | 154.0 | 34 | 453% ⚠️ | Wed 09 Sep |
| **D** | Debashis | 67 | 65 | 95.0 | 34 | 279% ⚠️ | Fri 18 Sep |
...
|---|---|---|---|---:|
| `A-001` Maven multi-module skeleton: common, domain, api | Shivendra | Thu 06 Aug | Tue 15 Sep | +28d |
| `A-002` docker-compose.yml — MySQL 8.4, Redis 7, MinIO,  | Shivendra | Thu 06 Aug | Tue 15 Sep | +28d |
| `A-007` Flyway baseline 5/5 — masters & ops | Shivendra | Thu 06 Aug | Tue 15 Sep | +28d |
| `A-008` Immutability triggers — two per table | Shivendra | Thu 06 Aug | Tue 15 Sep | +28d |
| `A-009` Generated columns + indexes replacing PostgreSQL | Shivendra | Thu 06 Aug | Tue 15 Sep | +28d |
| `A-011` CI pipeline | Shivendra | Thu 06 Aug | Tue 15 Sep | +28d |
...
| `A-053` Cursor pagination + virtualised grid rendering b | Shivendra | Tue 29 Sep | Sun 16 Aug | +20d |
...
|---:|---|---|---|---:|---|---|---|
| 1 | `D-101` | Debashis | WhatsApp provider adapter — behind the outbox with d | 3 | Tue 15 Sep | Thu 17 Sep | — |
| 2 | `D-102` | Debashis | Escalation notification events | 1 | Fri 18 Sep | Fri 18 Sep | Debashis was busy on `D-101` |
...
gantt
    ...
    Sprint 0 — weeks 1–2 :done, a0, 2026-08-05, 30d
    M1 — Authentication & the scope guard — weeks :done, a1, 2026-08-07, 28d
    Hardening — weeks 17–18 :active, a2, 2026-08-12, 26d
    M2 — Immutability core — weeks 8–9 :done, a3, 2026-08-14, 1d
    M6 — Dashboard & reports — weeks 10–16 :done, a4, 2026-08-15, 22d
    section Phase 2 — Client Onboarding
    OB0 — Gate & schema :done, a5, 2026-09-03, 9d
...
gantt
    ...
    section Phase 2 — Client Onboarding
    OB3 — Notifications :d7, 2026-09-15, 4d
```
...
|---|---|---|---:|---|---|---|---:|---|
|  | `A-001` | Maven multi-module skeleton: common, domain, api, worker | 1 | — | Tue 15 Sep | Tue 15 Sep | 0 | ✅ done |
|  | `A-002` | docker-compose.yml — MySQL 8.4, Redis 7, MinIO, Mailpit | 1 | `A-001` | Tue 15 Sep | Tue 15 Sep | 0 | ✅ done |
...
|  | `A-007` | Flyway baseline 5/5 — masters & ops | 1.5 | `A-005` | Tue 15 Sep | Tue 15 Sep | 0 | ✅ done |
|  | `A-008` | Immutability triggers — two per table | 1 | `A-004` `A-005` | Tue 15 Sep | Tue 15 Sep | 0 | ✅ done |
|  | `A-009` | Generated columns + indexes replacing PostgreSQL partial indexes | 0.5 | `A-006` | Tue 15 Sep | Tue 15 Sep | 0 | ✅ done |
|  | `A-010` | Two DB users: edutrack_app | 0.5 | `A-009` ᶦ | Thu 06 Aug | Thu 06 Aug | 19 | ✅ done |
|  | `A-011` | CI pipeline | 1.5 | `A-001` | Tue 15 Sep | Tue 15 Sep | 1 | ✅ done |
...
|  | `A-030` | Login screen | 1.5 | `A-020` `C-003` | Tue 15 Sep | Tue 15 Sep | 0 | ✅ done |
...
|  | `A-058` | Widgets 16–19 — stage funnel, rework/ping-pong, avg time per stage | 2.5 | `A-056` `C-049` | Fri 21 Aug | Fri 21 Aug | 18 | ✅ done |
|  | `A-059` | Widget 20 — client-wise volume | 1 | `A-056` `B-029` | Tue 15 Sep | Tue 15 Sep | 1 | ✅ done |
...
|  | `A-063` | Reports hub | 2 | `A-051` `C-003` ᶦ | Mon 17 Aug | Tue 18 Aug | 18 | ✅ done |
|  | `A-064` | Export engine — Excel, CSV, PDF | 2 | `A-063` ᶦ | Tue 18 Aug | Tue 18 Aug | 20 | ✅ done |
|  | `A-065` | Scheduled report email (daily/weekly/monthly) | 1 | `A-064` `D-029` | Wed 19 Aug | Wed 19 Aug | 20 | ✅ done |
|  | `A-066` | Reports 1–6 | 3 | `A-063` ᶦ | Tue 18 Aug | Tue 18 Aug | 19 | ✅ done |
|  | `A-067` | Reports 7–12 | 3 | `A-066` ᶦ | Tue 18 Aug | Tue 18 Aug | 20 | ✅ done |
|  | `A-068` | Reports 13–18 | 3 | `A-067` `C-058` | Fri 21 Aug | Fri 21 Aug | 18 | ✅ done |
|  | `A-069` | Resource 360° profile | 1.5 | `A-066` `B-010` | Tue 18 Aug | Tue 18 Aug | 21 | ✅ done |
|  | `A-070` | "Born critical vs became critical" report | 1 | `A-066` `D-028` | Wed 19 Aug | Wed 19 Aug | 20 | ✅ done |
|  | `A-071` | Audit Log Viewer | 1.5 | `A-034` ᶦ | Tue 18 Aug | Tue 18 Aug | 21 | ✅ done |
|  | `A-072` | Global search + ticket-ID deep link | 1.5 | `A-009` `C-005` ᶦ | Wed 19 Aug | Wed 19 Aug | 20 | ✅ done |
|  | `A-073` | Performance | 2 | `A-053` `B-007` ᶦ | Mon 07 Sep | Tue 08 Sep | 4 | ✅ done |
|  | `A-074` | Security | 2 | `A-036` ᶦ | Thu 20 Aug | Thu 20 Aug | 17 | ✅ done |
|  | `A-075` | Go-live runbook, deployment, TLS, secrets in vault | 2 | `A-073` `A-074` ᶦ | Tue 15 Sep | Wed 16 Sep | 0 | ▫️ to do |
|  | `A-076` | Login throttle — the half A-021 deferred | 1 | — | Wed 12 Aug | Wed 12 Aug | 25 | ✅ done |
|  | `A-077` | Project dashboard | 2 | — | Fri 21 Aug | Fri 21 Aug | 18 | ✅ done |
...
|  | `A-107` | Sign-off, outbox and escalation tables | 2 | `A-104` ᶦ | Thu 03 Sep | Thu 03 Sep | 3 | ✅ done |
...
|  | `A-120` | Public sign-off surface | 3 | `A-107` ᶦ | Tue 08 Sep | Tue 08 Sep | 1 | ✅ done |
|  | `A-121` | OTP issue and verify -- against the SPOC's registered email or… | 2 | `A-120` ᶦ | Tue 08 Sep | Tue 08 Sep | 2 | ✅ done |
...
|  | `A-125` | client_accounts + CLIENT principal — identity-layer table | 3 | `A-110` ᶦ | Tue 15 Sep | Tue 15 Sep | 2 | ✅ done |
...
|  | `A-128` | Service dependency & escalation schema | 1 | `A-103` ᶦ | Thu 03 Sep | Thu 03 Sep | 10 | ✅ done |
...
|  | `B-010` | Resource list | 2 | `B-005` `C-003` `A-012` | Tue 11 Aug | Tue 11 Aug | 22 | ✅ done |
...
|  | `B-039` | Status/stage/workflow master tab 1 | 2 | `B-003` `C-003` ᶦ | Tue 18 Aug | Tue 18 Aug | 13 | ✅ done |
|  | `B-040` | Tab 2 — stages | 2 | `B-039` | Tue 18 Aug | Tue 18 Aug | 14 | ✅ done |
|  | `B-041` | Tab 3 | 2.5 | `B-040` `B-050` | Fri 21 Aug | Fri 21 Aug | 17 | ✅ done |
| 🔴 | `B-042` | Stages in use may be deprecated, never deleted | 1 | `B-040` | Wed 19 Aug | Wed 19 Aug | 19 | ✅ done |
|  | `B-043` | Workflow template designer | 3 | `B-041` `B-042` | Fri 21 Aug | Fri 21 Aug | 18 | ✅ done |
|  | `B-050` | Ribbon segment component — 6 states | 2.5 | `C-003` `C-042` | Thu 20 Aug | Thu 20 Aug | 17 | ✅ done |
|  | `B-051` | Compact dot variant for the ticket list. — components/ribbon/ | 1 | `B-050` ᶦ | Sat 22 Aug | Sat 22 Aug | 17 | ✅ done |
|  | `B-052` | Ribbon accessibility | 1.5 | `B-050` ᶦ | Sat 22 Aug | Sat 22 Aug | 17 | ✅ done |
|  | `B-053` | Readability at 8 stages on a laptop | 2 | `B-050` ᶦ | Sat 22 Aug | Sat 22 Aug | 17 | ✅ done |
|  | `B-060` | Client report | 2 | `A-064` `B-029` | Wed 19 Aug | Wed 19 Aug | 20 | ✅ done |
|  | `B-061` | Resource performance scorecard and workload/capacity report | 2 | `A-064` `B-010` | Wed 19 Aug | Wed 19 Aug | 20 | ✅ done |
|  | `B-062` | Export engine integration for all report types | 1.5 | `A-064` | Wed 19 Aug | Wed 19 Aug | 20 | ✅ done |
|  | `B-063` | Timesheet view — stage-aware, a resource's week across all tickets | 2 | `A-064` `C-061` | Wed 19 Aug | Wed 19 Aug | 20 | ✅ done |
| 🔴 | `B-064` | Module master read endpoint | 0.25 | `C-065` | Thu 20 Aug | Thu 20 Aug | 19 | ✅ done |
|  | `B-065` | 🟡 Timesheet approval | 1 | — | Sat 22 Aug | Sat 22 Aug | 17 | ✅ done |
|  | `B-066` | Client 360 | 2 | — | Sat 22 Aug | Sat 22 Aug | 17 | ✅ done |
|  | `B-067` | Masters index — the sidebar's Masters entry lands on a placeholder | 1 | — | Sat 22 Aug | Sat 22 Aug | 17 | ✅ done |
|  | `B-068` | Org settings screen — decided the API is enough | 1 | — | Sat 22 Aug | Sat 22 Aug | 17 | ✅ done |
...
|  | `B-115` | OB-09 | 2 | `A-121` ᶦ | Wed 09 Sep | Wed 09 Sep | 2 | ✅ done |
|  | `B-116` | Acceptance PDF | 2 | `B-115` ᶦ | Wed 09 Sep | Wed 09 Sep | 3 | ✅ done |
| 🔴 | `B-117` | The objection path | 1 | `B-115` ᶦ | Tue 15 Sep | Tue 15 Sep | 0 | ▫️ to do |
|  | `B-118` | Go-live flip | 1 | `B-116` ᶦ | Wed 16 Sep | Wed 16 Sep | 0 | ▫️ to do |
| 🔴 | `B-119` | CSAT — a public one-question page, storage, and a summary | 2 | `B-118` ᶦ | Thu 17 Sep | Fri 18 Sep | 0 | ▫️ to do |
...
|  | `C-032` | Stamping | 1 | `C-029` `C-042` | Wed 19 Aug | Wed 19 Aug | 20 | ✅ done |
...
|  | `C-035` | Effort logging, append-only, auto-stamped with current stage and… | 1.5 | `C-019` `A-040` | Tue 18 Aug | Tue 18 Aug | 15 | ✅ done |
...
|  | `C-042` | Transition service | 2.5 | `A-042` `B-040` | Wed 19 Aug | Wed 19 Aug | 14 | ✅ done |
| 🔴 | `C-043` | The golden rule — only the current stage owner | 1.5 | `C-042` `A-033` | Wed 19 Aug | Wed 19 Aug | 20 | ✅ done |
|  | `C-044` | Handoff dialog — next stage | 2.5 | `C-042` `C-035` | Wed 19 Aug | Wed 19 Aug | 15 | ✅ done |
|  | `C-045` | On submit: seal the current row | 2 | `C-044` `D-014` | Wed 19 Aug | Wed 19 Aug | 16 | ✅ done |
|  | `C-046` | Backward moves | 1.5 | `C-042` ᶦ | Thu 20 Aug | Thu 20 Aug | 18 | ✅ done |
|  | `C-047` | Skip a stage | 1 | `C-042` ᶦ | Tue 08 Sep | Tue 08 Sep | 6 | ✅ done |
|  | `C-048` | Force-move (OVERRIDE) — PM/Admin, logged as an override | 1 | `C-042` ᶦ | Thu 20 Aug | Thu 20 Aug | 19 | ✅ done |
|  | `C-049` | Reassignment within a stage does not create a new segment | 1.5 | `C-042` | Thu 20 Aug | Thu 20 Aug | 18 | ✅ done |
|  | `C-050` | Unassigned receiving role → ticket falls to a project-level queue… | 1 | `C-044` ᶦ | Thu 20 Aug | Thu 20 Aug | 19 | ✅ done |
| 🔴 | `C-051` | Ribbon component | 3 | `B-050` | Thu 20 Aug | Thu 20 Aug | 18 | ✅ done |
|  | `C-052` | Interactions | 2 | `C-051` ᶦ | Thu 20 Aug | Thu 20 Aug | 19 | ✅ done |
|  | `C-053` | Cycle selector above the ribbon; selecting cycle 1 renders that… | 1.5 | `C-051` `C-038` | Thu 20 Aug | Thu 20 Aug | 19 | ✅ done |
|  | `C-054` | Cycle 2 · Iteration 3 chips | 1 | `C-051` `C-046` | Thu 20 Aug | Thu 20 Aug | 19 | ✅ done |
...
|  | `C-061` | Effort tab — every log line, sum per cycle + grand total | 1 | `C-041` ᶦ | Tue 18 Aug | Tue 18 Aug | 20 | ✅ done |
...
|  | `C-066` | Shared rich-text editor in components/ui/ + Storybook | 1.5 | `C-003` | Tue 11 Aug | Tue 11 Aug | 25 | ✅ done |
| 🔴 | `C-071` | Per-project settings are configurable and ignored | 1 | — | Fri 21 Aug | Fri 21 Aug | 18 | ✅ done |
|  | `C-072` | A deactivated priority can still be chosen | 1 | — | Fri 21 Aug | Fri 21 Aug | 18 | ✅ done |
...
|  | `C-121` | CP-01..CP-04 | 4 | `A-126` `B-125` ᶦ | Wed 09 Sep | Wed 09 Sep | 6 | ✅ done |
|  | `C-122` | CP-05..CP-07 | 2 | `C-121` `A-127` ᶦ | Wed 09 Sep | Wed 09 Sep | 7 | ✅ done |
...
|  | `C-126` | Portal escalation flow | 2 | `C-121` `A-128` ᶦ | Wed 09 Sep | Wed 09 Sep | 7 | ✅ done |
...
| | Task | Title | Est | Predecessors | Start | End | Float | Status |
|---|---|---|---:|---|---|---|---:|---|
|  | `C-055` | Roll-up grid | 2 | `C-042` `B-024` | Wed 19 Aug | Wed 19 Aug | 18 | ✅ done |
| 🔴 | `C-056` | Active vs idle split | 1.5 | `C-055` | Wed 19 Aug | Wed 19 Aug | 19 | ✅ done |
|  | `C-057` | Per-resource roll-up + cycle total + all-cycles total | 1.5 | `C-056` ᶦ | Wed 19 Aug | Wed 19 Aug | 20 | ✅ done |
|  | `C-058` | Roll-up query | 1 | `C-055` | Wed 19 Aug | Wed 19 Aug | 19 | ✅ done |
|  | `C-062` | Stage Queue / team inbox | 2 | `C-014` `C-042` | Wed 19 Aug | Wed 19 Aug | 18 | ✅ done |
|  | `C-065` | product_modules master + the four columns on tickets — table | 0.5 | `D-060` | Wed 19 Aug | Wed 19 Aug | 18 | ✅ done |
|  | `C-067` | Backend wiring for all four fields | 1 | `C-065` `C-010` | Wed 19 Aug | Wed 19 Aug | 19 | ✅ done |
|  | `C-068` | Create form S-19 — the new "Where it happened" group | 1 | `C-066` `C-067` | Wed 19 Aug | Wed 19 Aug | 20 | ✅ done |
|  | `C-069` | Detail page S-20 shows all four, inline-editable | 0.5 | `C-019` `C-067` | Wed 19 Aug | Wed 19 Aug | 20 | ✅ done |
|  | `C-070` | List S-17 gains a Module filter | 0.5 | `C-014` `C-067` | Wed 19 Aug | Wed 19 Aug | 20 | ✅ done |
...
| 🔴 | `D-010` | Outbox worker pattern | 2.5 | `A-006` `A-012` | Fri 07 Aug | Fri 07 Aug | 24 | ✅ done |
|  | `D-011` | @Scheduled + ShedLock | 1 | `D-010` ᶦ | Fri 07 Aug | Fri 07 Aug | 25 | ✅ done |
...
|  | `D-030` | Mail body | 1.5 | `D-029` ᶦ | Mon 17 Aug | Mon 17 Aug | 16 | ✅ done |
...
|  | `D-037` | All 15 mail events from §4B.6 wired | 2 | `D-030` `D-036` ᶦ | Mon 17 Aug | Fri 21 Aug | 17 | ✅ done |
...
|  | `D-050` | Chat engine, three surfaces one engine | 3 | `D-014` `C-005` | Sat 08 Aug | Sat 08 Aug | 17 | ✅ done |
...
|  | `D-053` | File and image share, emoji, message search | 2 | `D-050` ᶦ | Sat 08 Aug | Fri 21 Aug | 18 | ✅ done |
...
|  | `D-058` | Live ribbon advance | 1 | `D-014` `C-045` | Thu 20 Aug | Fri 21 Aug | 16 | ✅ done |
|  | `D-059` | Team inbox live updates | 1 | `D-058` `C-062` | Thu 20 Aug | Fri 21 Aug | 18 | ✅ done |
|  | `D-060` | Ticket "where it happened" fields in the contract and the mock… | 0.5 | `D-004` | Tue 11 Aug | Tue 11 Aug | 23 | ✅ done |
...
| 🔴 | `D-065` | The chat React surface | 3 | — | Thu 20 Aug | Thu 20 Aug | 19 | ✅ done |
|  | `D-066` | 🟡 S-12 promises "Admin can add levels" and the contract cannot… | 1 | — | Thu 20 Aug | Fri 21 Aug | 18 | ✅ done |
| ▲ | `D-101` | WhatsApp provider adapter — behind the outbox with delivery webhooks | 3 | `B-110` ᶦ | Tue 15 Sep | Thu 17 Sep | 0 | ▫️ to do |
| ▲ | `D-102` | Escalation notification events | 1 | `B-110` ᶦ | Fri 18 Sep | Fri 18 Sep | 0 | ▫️ to do |
