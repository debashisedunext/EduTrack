...
**Generated Fri 21 Aug 2026 · day 14 of the plan · finish forecast Fri 04 Sep**
...
| Zero float (no slack at all) | 8 | 12.5 |

### By developer

| Stream | Developer | Tasks | Done | Effort | Working days available | Load | Finishes |
|---|---|---:|---:|---:|---:|---:|---|
| **A** | Shivendra | 65 | 61 | 95.0 | 24 | 396% ⚠️ | Fri 28 Aug |
...
|---|---|---|---|---:|
| `A-023` Opaque refresh token, 7 days, HttpOnly + Secure  | Shivendra | Fri 14 Aug | Mon 10 Aug | +16d |
| `A-025` Logout | Shivendra | Tue 18 Aug | Mon 10 Aug | +14d |
| `A-026` Forced password change on first login — must_cha | Shivendra | Wed 19 Aug | Mon 10 Aug | +13d |
| `B-007` Ticket fixture corpus | Ayush | Wed 19 Aug | Mon 10 Aug | +13d |
| `A-027` Forgot/reset password — single-use, 30-min TTL,  | Shivendra | Thu 20 Aug | Mon 10 Aug | +12d |
| `C-011` Ticket ID generation | Divyansh | Thu 20 Aug | Mon 10 Aug | +12d |
...
| `B-006` MapStruct base configuration | Ayush | Fri 21 Aug | Mon 10 Aug | +11d |
| `B-031` Step 1 — template download | Ayush | Tue 25 Aug | Mon 17 Aug | +10d |
| `C-010` Create ticket — all field groups from blueprint  | Divyansh | Tue 25 Aug | Mon 10 Aug | +9d |
| `B-032` Step 2 — upload, max 5 MB / 5,000 rows, event-dr | Ayush | Thu 27 Aug | Mon 17 Aug | +8d |
| `C-013` Actions: Save & Assign · Save as Draft · Save &  | Divyansh | Wed 26 Aug | Mon 10 Aug | +8d |
| `B-034` Step 4 — dry-run validation preview | Ayush | Wed 02 Sep | Mon 17 Aug | +4d |
| `C-015` Saved views | Divyansh | Tue 01 Sep | Mon 10 Aug | +4d |
| `C-016` Row colour cues | Divyansh | Wed 02 Sep | Mon 10 Aug | +3d |
...
| 6 | `B-043` | Ayush | Workflow template designer | 3 | Fri 21 Aug | Sat 22 Aug | `B-041` finished |
| 7 | `B-051` | Ayush | Compact dot variant for the ticket list | 1 | Sat 22 Aug | Tue 25 Aug | Ayush was busy on `B-043` |
| 8 | `B-052` | Ayush | Ribbon accessibility | 1.5 | Tue 25 Aug | Wed 26 Aug | Ayush was busy on `B-051` |
| 9 | `B-053` | Ayush | Readability at 8 stages on a laptop | 2 | Thu 27 Aug | Fri 28 Aug | Ayush was busy on `B-052` |
| 10 | `B-065` | Ayush | 🟡 Timesheet approval | 1 | Sat 29 Aug | Sat 29 Aug | Ayush was busy on `B-053` |
| 11 | `B-066` | Ayush | Client 360 | 2 | Tue 01 Sep | Wed 02 Sep | Ayush was busy on `B-065` |
| 12 | `B-067` | Ayush | Masters index — the sidebar's Masters entry lands on | 1 | Thu 03 Sep | Thu 03 Sep | Ayush was busy on `B-066` |
| 13 | `B-068` | Ayush | 🟡 Org settings screen — or the decision that the API | 1 | Fri 04 Sep | Fri 04 Sep | Ayush was busy on `B-067` |
...
gantt
    ...
    M6 — Dashboard & reports — weeks 10–16 :active, a4, 2026-08-15, 6d
```
...
gantt
    ...
    excludes weekends
    section Milestones
    Sprint 0 — weeks 1–2 :done, b0, 2026-08-06, 23d
    M3 — Master data — weeks 3–9 :active, b1, 2026-08-10, -9d
    Weeks 12–14 — M6 reports :active, b2, 2026-08-19, 13d
    Weeks 10–11 — join Stream C on the ribbon :active, b3, 2026-08-20, 7d
```
...
gantt
    ...
    Infrastructure — weeks 3–5 :done, d1, 2026-08-07, 22d
...
|---|---|---|---:|---|---|---|---:|---|
|  | `A-001` | Maven multi-module skeleton: common, domain, api, worker | 1 | — | Fri 21 Aug | Fri 21 Aug | 8 | ✅ done |
|  | `A-002` | docker-compose.yml — MySQL 8.4, Redis 7, MinIO, Mailpit | 1 | `A-001` | Fri 21 Aug | Fri 21 Aug | 9 | ✅ done |
|  | `A-003` | Flyway baseline 1/5 — identity | 1 | `A-002` | Wed 05 Aug | Wed 05 Aug | 0 | ✅ done |
|  | `A-004` | Flyway baseline 2/5 — tickets | 1.5 | `A-003` | Wed 05 Aug | Wed 05 Aug | 4 | ✅ done |
|  | `A-005` | Flyway baseline 3/5 — workflow | 1 | `A-004` | Wed 05 Aug | Wed 05 Aug | 5 | ✅ done |
|  | `A-006` | Flyway baseline 4/5 — clients & content | 1.5 | `A-007` | Thu 06 Aug | Thu 06 Aug | 0 | ✅ done |
|  | `A-007` | Flyway baseline 5/5 — masters & ops | 1.5 | `A-005` | Fri 21 Aug | Fri 21 Aug | 9 | ✅ done |
|  | `A-008` | Immutability triggers — two per table | 1 | `A-004` `A-005` | Fri 21 Aug | Fri 21 Aug | 8 | ✅ done |
|  | `A-009` | Generated columns + indexes replacing PostgreSQL partial indexes | 0.5 | `A-006` | Fri 21 Aug | Fri 21 Aug | 9 | ✅ done |
|  | `A-010` | Two DB users: edutrack_app | 0.5 | `A-009` ᶦ | Thu 06 Aug | Thu 06 Aug | 2 | ✅ done |
|  | `A-011` | CI pipeline | 1.5 | `A-001` | Fri 21 Aug | Fri 21 Aug | 10 | ✅ done |
...
|  | `A-030` | Login screen | 1.5 | `A-020` `C-003` | Fri 21 Aug | Fri 21 Aug | 9 | ✅ done |
...
|  | `A-051` | 5-minute refresh worker. Dashboard reads never issue live COUNT() | 1 | `A-050` | Sat 15 Aug | Tue 18 Aug | 1 | ✅ done |
...
|  | `A-058` | Widgets 16–19 — stage funnel, rework/ping-pong, avg time per stage | 2.5 | `A-056` `C-049` | Fri 21 Aug | Fri 21 Aug | 2 | 🔵 in review |
|  | `A-059` | Widget 20 — client-wise volume | 1 | `A-056` `B-029` | Fri 21 Aug | Sat 22 Aug | 3 | ▫️ to do |
...
|  | `A-073` | Performance | 2 | `A-053` `B-007` ᶦ | Sat 22 Aug | Wed 26 Aug | 4 | ▫️ to do |
|  | `A-074` | Security | 2 | `A-036` ᶦ | Thu 20 Aug | Thu 20 Aug | 8 | ✅ done |
|  | `A-075` | Go-live runbook, deployment, TLS, secrets in vault | 2 | `A-073` `A-074` ᶦ | Wed 26 Aug | Fri 28 Aug | 5 | ▫️ to do |
...
|  | `B-004` | Seed: 3 workflow templates with their stages — Standard Dev Flow | 1 | `A-005` | Fri 07 Aug | Fri 07 Aug | 4 | ✅ done |
...
|  | `B-041` | Tab 3 | 2.5 | `B-040` `B-050` | Fri 21 Aug | Fri 21 Aug | 0 | ✅ done |
| 🔴 | `B-042` | Stages in use may be deprecated, never deleted | 1 | `B-040` | Wed 19 Aug | Wed 19 Aug | 0 | ✅ done |
| ▲ | `B-043` | Workflow template designer | 3 | `B-041` `B-042` | Fri 21 Aug | Sat 22 Aug | 0 | 🟡 50% |
|  | `B-050` | Ribbon segment component — 6 states | 2.5 | `C-003` `C-042` | Thu 20 Aug | Thu 20 Aug | 0 | ✅ done |
| ▲ | `B-051` | Compact dot variant for the ticket list | 1 | `B-050` ᶦ | Sat 22 Aug | Tue 25 Aug | 0 | ▫️ to do |
| ▲ | `B-052` | Ribbon accessibility | 1.5 | `B-050` ᶦ | Tue 25 Aug | Wed 26 Aug | 0 | ▫️ to do |
| ▲ | `B-053` | Readability at 8 stages on a laptop | 2 | `B-050` ᶦ | Thu 27 Aug | Fri 28 Aug | 0 | ▫️ to do |
...
| ▲ | `B-065` | 🟡 Timesheet approval | 1 | — | Sat 29 Aug | Sat 29 Aug | 0 | ▫️ to do |
| ▲ | `B-066` | Client 360 | 2 | — | Tue 01 Sep | Wed 02 Sep | 0 | ▫️ to do |
| ▲ | `B-067` | Masters index — the sidebar's Masters entry lands on a placeholder | 1 | — | Thu 03 Sep | Thu 03 Sep | 0 | ▫️ to do |
| ▲ | `B-068` | 🟡 Org settings screen — or the decision that the API is enough | 1 | — | Fri 04 Sep | Fri 04 Sep | 0 | ▫️ to do |
...
|  | `C-049` | Reassignment within a stage does not create a new segment | 1.5 | `C-042` | Thu 20 Aug | Thu 20 Aug | 2 | ✅ done |
