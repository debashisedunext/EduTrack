...
**Generated Thu 20 Aug 2026 · day 13 of the plan · finish forecast Tue 08 Sep**
...
| | Tasks | Effort (days) |
|---|---:|---:|
| Complete | 205 of 236 (87%) | 302.5 of 353.8 (86%) |
| In flight | 9 | 11.8 |
| On the driving chain | 12 | 19.0 |
| Zero float (no slack at all) | 14 | 27.0 |

### By developer

| Stream | Developer | Tasks | Done | Effort | Working days available | Load | Finishes |
|---|---|---:|---:|---:|---:|---:|---|
| **A** | Shivendra | 64 | 57 | 93.0 | 26 | 358% ⚠️ | Sat 05 Sep |
| **B** | Ayush | 52 | 44 | 85.8 | 26 | 330% ⚠️ | Fri 04 Sep |
| **C** | Divyansh | 57 | 45 | 88.0 | 26 | 338% ⚠️ | Tue 08 Sep |
| **D** | Debashis | 63 | 59 | 87.0 | 26 | 335% ⚠️ | Tue 25 Aug |
...
| `C-016` Row colour cues | Divyansh | Wed 02 Sep | Mon 10 Aug | +5d |
...
| 10 | `C-046` | Divyansh | Backward moves | 1.5 | Tue 25 Aug | Wed 26 Aug | Divyansh was busy on `C-050` |
| 11 | `C-047` | Divyansh | Skip a stage | 1 | Thu 27 Aug | Thu 27 Aug | Divyansh was busy on `C-046` |
| 12 | `C-051` | Divyansh | Ribbon component | 3 | Fri 28 Aug | Tue 01 Sep | Divyansh was busy on `C-047` |
| 13 | `C-052` | Divyansh | Interactions | 2 | Wed 02 Sep | Thu 03 Sep | `C-051` finished |
| 14 | `C-053` | Divyansh | Cycle selector above the ribbon; selecting cycle 1 r | 1.5 | Fri 04 Sep | Sat 05 Sep | Divyansh was busy on `C-052` |
| 15 | `C-054` | Divyansh | Cycle 2 · Iteration 3 chips | 1 | Sat 05 Sep | Tue 08 Sep | Divyansh was busy on `C-053` |
...
gantt
    ...
    Weeks 12–14 — M6 reports :active, b2, 2026-08-19, 13d
...
gantt
    ...
    M4 — Tickets — weeks 3–14 :done, d6, 2026-08-19, 1d
```
...
|---|---|---|---:|---|---|---|---:|---|
|  | `A-001` | Maven multi-module skeleton: common, domain, api, worker | 1 | — | Thu 20 Aug | Thu 20 Aug | 11 | ✅ done |
|  | `A-002` | docker-compose.yml — MySQL 8.4, Redis 7, MinIO, Mailpit | 1 | `A-001` | Thu 20 Aug | Thu 20 Aug | 12 | ✅ done |
...
|  | `A-007` | Flyway baseline 5/5 — masters & ops | 1.5 | `A-005` | Thu 20 Aug | Thu 20 Aug | 12 | ✅ done |
|  | `A-008` | Immutability triggers — two per table | 1 | `A-004` `A-005` | Thu 20 Aug | Thu 20 Aug | 11 | ✅ done |
|  | `A-009` | Generated columns + indexes replacing PostgreSQL partial indexes | 0.5 | `A-006` | Thu 20 Aug | Thu 20 Aug | 12 | ✅ done |
|  | `A-010` | Two DB users: edutrack_app | 0.5 | `A-009` ᶦ | Thu 06 Aug | Thu 06 Aug | 1 | ✅ done |
|  | `A-011` | CI pipeline | 1.5 | `A-001` | Thu 20 Aug | Thu 20 Aug | 13 | ✅ done |
...
|  | `A-030` | Login screen | 1.5 | `A-020` `C-003` | Thu 20 Aug | Thu 20 Aug | 12 | ✅ done |
...
|  | `A-058` | Widgets 16–19 — stage funnel, rework/ping-pong, avg time per stage | 2.5 | `A-056` `C-049` | Thu 03 Sep | Sat 05 Sep | 1 | ▫️ to do |
...
|  | `A-070` | "Born critical vs became critical" report | 1 | `A-066` `D-028` | Thu 20 Aug | Thu 20 Aug | 11 | 🔵 in review |
...
<details>
<summary><b>Stream B — Masters & Clients · Ayush · 52 tasks</b></summary>
...
| 🔴 | `B-042` | Stages in use may be deprecated, never deleted | 1 | `B-040` | Wed 19 Aug | Wed 19 Aug | 3 | ✅ done |
...
|  | `B-051` | Compact dot variant for the ticket list | 1 | `B-050` ᶦ | Fri 28 Aug | Sat 29 Aug | 1 | ▫️ to do |
|  | `B-052` | Ribbon accessibility | 1.5 | `B-050` ᶦ | Sat 29 Aug | Tue 01 Sep | 2 | ▫️ to do |
|  | `B-053` | Readability at 8 stages on a laptop | 2 | `B-050` ᶦ | Wed 02 Sep | Thu 03 Sep | 2 | ▫️ to do |
...
| 🔴 | `B-064` | Module master read endpoint | 0.25 | `C-065` | Thu 20 Aug | Thu 20 Aug | 12 | 🔵 in review |
|  | `B-065` | 🟡 Timesheet approval | 1 | — | Fri 04 Sep | Fri 04 Sep | 2 | ▫️ to do |
...
| ▲ | `C-032` | Stamping | 1 | `C-029` `C-042` | Thu 20 Aug | Thu 20 Aug | 6 | 🔵 in review |
...
| ▲ | `C-044` | Handoff dialog — next stage | 2.5 | `C-042` `C-035` | Thu 20 Aug | Thu 20 Aug | 7 | 🔵 in review |
| ▲ | `C-045` | On submit: seal the current row | 2 | `C-044` `D-014` | Fri 21 Aug | Fri 21 Aug | 7 | 🟡 50% |
...
| ▲ | `C-048` | Force-move (OVERRIDE) — PM/Admin, logged as an override | 1 | `C-042` ᶦ | Sat 22 Aug | Sat 22 Aug | 7 | 🟡 50% |
| ▲ | `C-049` | Reassignment within a stage does not create a new segment | 1.5 | `C-042` | Sat 22 Aug | Sat 22 Aug | 8 | 🔵 in review |
| ▲ | `C-050` | Unassigned receiving role → ticket falls to a project-level queue… | 1 | `C-044` ᶦ | Tue 25 Aug | Tue 25 Aug | 8 | 🔵 in review |
...
| ▲ | `C-054` | Cycle 2 · Iteration 3 chips | 1 | `C-051` `C-046` | Sat 05 Sep | Tue 08 Sep | 0 | ▫️ to do |
