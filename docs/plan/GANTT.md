...
gantt
    ...
    M6 — Dashboard & reports — weeks 10–16 :active, a4, 2026-08-15, 11d
```
...
gantt
    ...
    M4 — Tickets — weeks 3–14 :active, d6, 2026-08-19, 3d
```
...
|  | `A-059` | Widget 20 — client-wise volume | 1 | `A-056` `B-029` | Tue 25 Aug | Wed 26 Aug | 0 | ▫️ to do |
...
|  | `A-063` | Reports hub | 2 | `A-051` `C-003` ᶦ | Mon 17 Aug | Tue 18 Aug | 2 | ✅ done |
...
|  | `A-066` | Reports 1–6 | 3 | `A-063` ᶦ | Tue 18 Aug | Tue 18 Aug | 3 | ✅ done |
|  | `A-067` | Reports 7–12 | 3 | `A-066` ᶦ | Tue 18 Aug | Tue 18 Aug | 4 | ✅ done |
|  | `A-068` | Reports 13–18 | 3 | `A-067` `C-058` | Wed 26 Aug | Sat 29 Aug | 0 | ▫️ to do |
...
|  | `A-073` | Performance | 2 | `A-053` `B-007` ᶦ | Sat 29 Aug | Wed 02 Sep | 0 | ▫️ to do |
|  | `A-074` | Security | 2 | `A-036` ᶦ | Thu 20 Aug | Thu 20 Aug | 9 | ✅ done |
|  | `A-075` | Go-live runbook, deployment, TLS, secrets in vault | 2 | `A-073` `A-074` ᶦ | Wed 02 Sep | Fri 04 Sep | 1 | ▫️ to do |
|  | `A-076` | Login throttle — the half A-021 deferred | 1 | — | Wed 12 Aug | Wed 12 Aug | 21 | ✅ done |
|  | `A-077` | Project dashboard | 2 | — | Fri 04 Sep | Tue 08 Sep | 2 | ▫️ to do |
...
|  | `C-019` | Detail shell + summary panel — every entity a link | 2 | `C-005` `D-004` | Tue 11 Aug | Tue 11 Aug | 17 | ✅ done |
...
|  | `C-035` | Effort logging, append-only, auto-stamped with current stage and… | 1.5 | `C-019` `A-040` | Tue 18 Aug | Tue 18 Aug | 13 | ✅ done |
...
|  | `C-044` | Handoff dialog — next stage | 2.5 | `C-042` `C-035` | Wed 19 Aug | Wed 19 Aug | 13 | ✅ done |
|  | `C-045` | On submit: seal the current row | 2 | `C-044` `D-014` | Wed 19 Aug | Wed 19 Aug | 14 | ✅ done |
...
| | Task | Title | Est | Predecessors | Start | End | Float | Status |
|---|---|---|---:|---|---|---|---:|---|
|  | `C-055` | Roll-up grid | 2 | `C-042` `B-024` | Wed 19 Aug | Wed 19 Aug | 2 | ✅ done |
...
|  | `C-058` | Roll-up query | 1 | `C-055` | Wed 19 Aug | Wed 19 Aug | 3 | ✅ done |
...
|  | `D-037` | All 15 mail events from §4B.6 wired | 2 | `D-030` `D-036` ᶦ | Fri 21 Aug | Fri 21 Aug | 12 | 🟡 100% |
...
|  | `D-053` | File and image share, emoji, message search | 2 | `D-050` ᶦ | Sat 22 Aug | Sat 22 Aug | 13 | ⛔ blocked |
...
|  | `D-058` | Live ribbon advance | 1 | `D-014` `C-045` | Thu 20 Aug | Thu 20 Aug | 14 | ✅ done |
|  | `D-059` | Team inbox live updates | 1 | `D-058` `C-062` | Thu 20 Aug | Thu 20 Aug | 15 | ✅ done |
...
|  | `D-066` | 🟡 S-12 promises "Admin can add levels" and the contract cannot… | 1 | — | Fri 21 Aug | Fri 21 Aug | 13 | 🔵 in review |
