 ...
 */
import type { ImportBatchFileName } from './importBatchFileName';
import type { ImportBatchStatus } from './importBatchStatus';
import type { ImportBatchErrorReportUrl } from './importBatchErrorReportUrl';
import type { ImportBatchImportedBy } from './importBatchImportedBy';
import type { ImportBatchImportedByName } from './importBatchImportedByName';
import type { ImportBatchReversedAt } from './importBatchReversedAt';

/**
 * One import run — the progress bar's poll, a row of B-037's history panel
...
reason.
 */
  errorReportUrl?: ImportBatchErrorReportUrl;
  /** `import_batches.created_at` — when the run was committed, not when it
 ...
 */
  importedBy?: ImportBatchImportedBy;
 ...
 */
  importedByName?: ImportBatchImportedByName;
 ...
 */
  reversedAt?: ImportBatchReversedAt;
  /** Rows this run **created** that the reversal deleted.
 ...
 */
  reversedRows: number;
  /** Rows this run created that the reversal could **not** delete, because
 ...
 */
  retainedRows: number;
  /** Whether `reverseImportBatch` would be accepted right now — **the
