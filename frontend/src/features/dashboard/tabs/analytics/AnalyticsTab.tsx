...
/**
 * A-054 shell + A-055 cards · S-05 tab 4.
 *
 * <p>Dashboard Rework Dev 1, PR 2 · moved verbatim out of {@code DashboardPage}
 * into its own tab, unchanged, per that PR's own rule: <b>do not tidy anything
 * on the way past.</b> {@code useDashboardVariant.ts} is read literally by
 * {@code DashboardVariantTest} on the backend, so its path and its
 * {@code OWN_WORK_ONLY} array stayed exactly where they were — only this
 * component moved.
 *
