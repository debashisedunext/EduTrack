      ...
      <section aria-labelledby="preview-heading" className="space-y-2 rounded-card border border-line p-4">
        <div className="flex items-baseline justify-between gap-4">
          ...
          <div className="flex items-baseline gap-3">
            ...
            {/*
              B-043 · S-30. This tab previews the flow; the designer is where it
              is built. A link rather than a fourth tab, for the reason the route
              records in App.tsx.
            */}
            <Link
              to={`/masters/workflow/designer/${templateId}`}
